...
const Card = ({ title, detail, image, list, caption, link }) => {
    ...
    return (
        <li
            ref={ref}
            className="flex justify-center rounded-sm bg-white hover:shadow-2xl ring-1 duration-200 h-full bg-gray-50 h-68 w-3/5 md:w-96 ring-primary shadow-primary-200 m-8 p-4 md:px-6 shadow-lg hover:ring-4 hover:-translate-y-3"
        >
            <div className="text-center" onClick={handleOpen}>
                ...
                <p className=" text-sm lg:text-xl w-full text-primary text-left">
                    {caption}
                </p>
                <p className="text-2xl w-full text-black">{title}</p>
            </div>
            <Modal
            ...
            >
                <Fade in={open}>
                    <Box sx={style}>
                        <div className="relative flex flex-col lg:flex-row justify-center m-4">
                            <a
                                href={link}
                                className="m-auto w-full md:w-4/6 cursor-pointer rounded-lg lg:w-1/2  flex justify-center"
                            >
                                <img
                                    src={image}
                                    className="h-auto w-96 lg:w-full shadow-xl"
                                ></img>
                            </a>
                            <div className="my-8  m-auto md:mx-4 lg:mx-12 flex w-full flex-col items-start text-left justify-between px-6 lg:w-1/2  lg:pl-0 lg:py-6">
                                <div className="underline-offset-2 hover:underline">
                                    <h2 className="font-bold text-xl my-4 text-center lg:text-4xl">
                                        {title}
                                    </h2>
                                </div>
...
const Works = () => {
    return (
        <section
            className="min-h-screen items-center py-20"
